...
int main(int argc, const char **argv) {
    @autoreleasepool {
        ...
        int gpu_mode = 0;           // 0=builtin, 1=radix4_ilp
        ...
        printf("Hybrid v8: THRESH<=%u -> GPU | dataset=%s | CPU_threads=%d | GPU_mode=%s\n",
               THRESH, mixed ? "mixed50" : "uniform64", cpu_threads, (gpu_mode==0?"builtin":"radix4_ilp"));
        ...
        NSError *err=nil;
        NSString *mslPath = @"gpu_divider_hybrid_v8.metal";
        ...
        if (!p_builtin || !p_radix4){ fprintf(stderr,"Pipeline error: %s\n", err.localizedDescription.UTF8String); return 1; }
        ...
        // --- Benchmark GPU small-subset alone (both modes) ---
        ...
        id<MTLComputePipelineState> p_use = (gpu_mode==0 ? p_builtin : p_radix4);
